...
exports.getUnverifiedHighRiskBeliefs = getUnverifiedHighRiskBeliefs;
exports.getUnverifiedBeliefs = getUnverifiedBeliefs;
exports.getContradictedBeliefs = getContradictedBeliefs;
 ...
 */
function getContradictedBeliefs() {
    const store = SessionStore_1.SessionStore.getInstance();
    return store
        .getAllBeliefs()
 ...
 */
function detectContradictions(proposedActionContext) {
    const store = SessionStore_1.SessionStore.getInstance();
    ...
    for (const belief of allBeliefs) {
        ...
        if (belief.type === 'USER_CONSTRAINT' ||
            ...
            for (const [patternA, patternB] of NEGATION_PAIRS) {
                ...
                if ((contextMatchesA && beliefMatchesB) ||
...
//# sourceMappingURL=BeliefGraph.js.map