    ...
    resolveWebviewView(webviewView, _context, _token) {
        ...
        webviewView.webview.onDidReceiveMessage((message) => {
            switch (message.type) {
                ...
                case 'REJECT_PATCH':
                    this._latestDiffPatch = undefined;
                    void vscode.window.showInformationMessage('The pending patch was discarded.');
                    break;
                case 'APPROVE_FILE_CHANGE':
                    ...
                    void vscode.window.showInformationMessage(`Approved ${message.payload.fileChange.path}.`);
                    break;
                case 'REJECT_FILE_CHANGE':
                    this._latestDiffPatch = undefined;
                    this._onFileChangeRejected.fire(message.payload);
                    void vscode.window.showInformationMessage(`Rejected ${message.payload.fileChange.path}.`);
                    break;
            }
        });
    }
